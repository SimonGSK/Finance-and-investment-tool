...
2. **An interactive web dashboard** (`ask-vs-akt-graf.html`) — a browser-based version of the same calculations, with sliders and live charts. [Live demo](#) *(https://simongsk.github.io/Stock-portfolio-tool/)*.
